...
class DataLoader(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        for i in range(self._time_step+self._num_pred):
            imim = self.videos[video_name]['frame'][frame_name+i]
...
data_path = '/home/user/Documents/VADSET/ped2/testing/frames'
t_length = 16

train_dataset = DataLoader(data_path, transforms.Compose([
             transforms.ToTensor(),          
             ]), resize_height=256, resize_width=256, time_step=t_length-1)

loader = data.DataLoader(train_dataset, batch_size = 4, 
